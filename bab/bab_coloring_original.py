...
from heuristics.coloring.networkx_coloring import NetworkxColoring
...
class BranchAndBoundColoringSolver:
    ...
    def _create_node(
        ...
        clique_heuristic = NetworkxClique(graph)
        clique = clique_heuristic.get_clique()
        lb = clique_heuristic.get_clique_number()

        coloring_heuristic = NetworkxColoring(
            graph,
            strategy=self.coloring_strategy,
        )
        coloring = coloring_heuristic.get_coloring()
        ub = coloring_heuristic.get_number_of_colors()
